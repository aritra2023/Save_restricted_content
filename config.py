...
LOG_GROUP    = int(os.getenv("LOG_GROUP", "--1004298619601"))
FORCE_SUB    = int(os.getenv("FORCE_SUB", "--1004496194166"))
...
ADMIN_CONTACT = os.getenv("ADMIN_CONTACT", "https://t.me/itzishan")
